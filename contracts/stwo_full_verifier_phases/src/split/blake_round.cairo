//! Two-half fork of the vendored `blake_round` component eval along the
...
/// (59 relation numerators). Returns the seam carry
...
pub fn half_a(
    ...
    carry.append(blake_round_sigma_sum_0);
    carry.append(range_check_7_2_5_sum_1);
    carry.append(memory_address_to_id_sum_2);
    carry.append(memory_id_to_big_sum_3);
    carry.append(range_check_7_2_5_sum_4);
    ...
    carry.append(range_check_7_2_5_sum_34);
    carry.append(memory_address_to_id_sum_35);
    carry.append(memory_id_to_big_sum_36);
    carry.append(range_check_7_2_5_sum_37);
    carry.append(memory_address_to_id_sum_38);
    carry.append(memory_id_to_big_sum_39);
    carry.append(range_check_7_2_5_sum_40);
    carry.append(memory_address_to_id_sum_41);
    carry.append(memory_id_to_big_sum_42);
    carry.append(range_check_7_2_5_sum_43);
    carry.append(memory_address_to_id_sum_44);
    carry.append(memory_id_to_big_sum_45);
    carry.append(range_check_7_2_5_sum_46);
    carry.append(memory_address_to_id_sum_47);
    carry.append(memory_id_to_big_sum_48);
    carry.append(blake_g_sum_49);
    carry.append(blake_g_sum_50);
    carry.append(blake_g_sum_51);
    carry.append(blake_g_sum_52);
    carry.append(blake_g_sum_53);
    carry.append(blake_g_sum_54);
    carry.append(blake_g_sum_55);
    carry.append(blake_g_sum_56);
    carry.append(blake_round_sum_57);
    carry.append(blake_round_sum_58);
    carry
}

//! Multi-part fork of the vendored `blake_round` component eval along the
...
//! vendor/stwo_cairo_verifier/crates/cairo_air/src/components/blake_round.cairo
//! — do not edit by hand; re-run the script after a vendor bump.


use core::num::traits::Zero;
use stwo_cairo_air::components::subroutines::read_u_32::read_u_32_evaluate;
use stwo_cairo_air::components::blake_round::Component;
...
/// A part 1/3 of the trace-mask eval: re-reads the
/// trace destructure (114/212 columns unboxed) and returns the mid-A
/// carry: claimed_sum + the 118 accumulators + 0 crossing tmps
/// (119 QM31s = 476 felts).
pub fn half_a1(
    component: @Component,
    ref sum: QM31,
    ...
    blake_round_sigma_sum_0 = component
    ...
    out.append(blake_round_sigma_sum_0);
    out.append(numerator_0);
    out.append(range_check_7_2_5_sum_1);
    out.append(numerator_1);
    out.append(memory_address_to_id_sum_2);
    out.append(numerator_2);
    out.append(memory_id_to_big_sum_3);
    out.append(numerator_3);
    out.append(range_check_7_2_5_sum_4);
    out.append(numerator_4);
    out.append(memory_address_to_id_sum_5);
    out.append(numerator_5);
    out.append(memory_id_to_big_sum_6);
    out.append(numerator_6);
    out.append(range_check_7_2_5_sum_7);
    out.append(numerator_7);
    out.append(memory_address_to_id_sum_8);
    out.append(numerator_8);
    out.append(memory_id_to_big_sum_9);
    out.append(numerator_9);
    out.append(range_check_7_2_5_sum_10);
    out.append(numerator_10);
    out.append(memory_address_to_id_sum_11);
    out.append(numerator_11);
    out.append(memory_id_to_big_sum_12);
    out.append(numerator_12);
    out.append(range_check_7_2_5_sum_13);
    out.append(numerator_13);
    out.append(memory_address_to_id_sum_14);
    out.append(numerator_14);
    out.append(memory_id_to_big_sum_15);
    out.append(numerator_15);
    out.append(range_check_7_2_5_sum_16);
    out.append(numerator_16);
    out.append(memory_address_to_id_sum_17);
    out.append(numerator_17);
    out.append(memory_id_to_big_sum_18);
    out.append(numerator_18);
    out.append(range_check_7_2_5_sum_19);
    out.append(numerator_19);
    out.append(memory_address_to_id_sum_20);
    out.append(numerator_20);
    out.append(memory_id_to_big_sum_21);
    out.append(numerator_21);
    out.append(range_check_7_2_5_sum_22);
    out.append(numerator_22);
    out.append(memory_address_to_id_sum_23);
    out.append(numerator_23);
    out.append(memory_id_to_big_sum_24);
    out.append(numerator_24);
    out.append(range_check_7_2_5_sum_25);
    out.append(numerator_25);
    out.append(memory_address_to_id_sum_26);
    out.append(numerator_26);
    out.append(memory_id_to_big_sum_27);
    out.append(numerator_27);
    out.append(range_check_7_2_5_sum_28);
    out.append(numerator_28);
    out.append(memory_address_to_id_sum_29);
    out.append(numerator_29);
    out.append(memory_id_to_big_sum_30);
    out.append(numerator_30);
    out.append(range_check_7_2_5_sum_31);
    out.append(numerator_31);
    out.append(memory_address_to_id_sum_32);
    out.append(numerator_32);
    out.append(memory_id_to_big_sum_33);
    out.append(numerator_33);
    out.append(range_check_7_2_5_sum_34);
    out.append(numerator_34);
    out.append(memory_address_to_id_sum_35);
    out.append(numerator_35);
    out.append(memory_id_to_big_sum_36);
    out.append(numerator_36);
    out.append(range_check_7_2_5_sum_37);
    out.append(numerator_37);
    out.append(memory_address_to_id_sum_38);
    out.append(numerator_38);
    out.append(memory_id_to_big_sum_39);
    out.append(numerator_39);
    out.append(range_check_7_2_5_sum_40);
    out.append(numerator_40);
    out.append(memory_address_to_id_sum_41);
    out.append(numerator_41);
    out.append(memory_id_to_big_sum_42);
    out.append(numerator_42);
    out.append(range_check_7_2_5_sum_43);
    out.append(numerator_43);
    out.append(memory_address_to_id_sum_44);
    out.append(numerator_44);
    out.append(memory_id_to_big_sum_45);
    out.append(numerator_45);
    out.append(range_check_7_2_5_sum_46);
    out.append(numerator_46);
    out.append(memory_address_to_id_sum_47);
    out.append(numerator_47);
    out.append(memory_id_to_big_sum_48);
    out.append(numerator_48);
    out.append(blake_g_sum_49);
    out.append(numerator_49);
    out.append(blake_g_sum_50);
    out.append(numerator_50);
    out.append(blake_g_sum_51);
    out.append(numerator_51);
    out.append(blake_g_sum_52);
    out.append(numerator_52);
    out.append(blake_g_sum_53);
    out.append(numerator_53);
    out.append(blake_g_sum_54);
    out.append(numerator_54);
    out.append(blake_g_sum_55);
    out.append(numerator_55);
    out.append(blake_g_sum_56);
    out.append(numerator_56);
    out.append(blake_round_sum_57);
    out.append(numerator_57);
    out.append(blake_round_sum_58);
    out.append(numerator_58);
    out
}

/// A part 2/3 of the trace-mask eval: re-reads the
/// trace destructure (129/212 columns unboxed) and returns the mid-A
/// carry: claimed_sum + the 118 accumulators + 0 crossing tmps
/// (119 QM31s = 476 felts).
pub fn half_a2(
    component: @Component,
    ...
    let claimed_sum = *component.claimed_sum;
    let mut blake_round_sigma_sum_0 = *carry.pop_front().unwrap();
    let mut numerator_0 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_1 = *carry.pop_front().unwrap();
    let mut numerator_1 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_2 = *carry.pop_front().unwrap();
    let mut numerator_2 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_3 = *carry.pop_front().unwrap();
    let mut numerator_3 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_4 = *carry.pop_front().unwrap();
    let mut numerator_4 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_5 = *carry.pop_front().unwrap();
    let mut numerator_5 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_6 = *carry.pop_front().unwrap();
    let mut numerator_6 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_7 = *carry.pop_front().unwrap();
    let mut numerator_7 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_8 = *carry.pop_front().unwrap();
    let mut numerator_8 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_9 = *carry.pop_front().unwrap();
    let mut numerator_9 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_10 = *carry.pop_front().unwrap();
    let mut numerator_10 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_11 = *carry.pop_front().unwrap();
    let mut numerator_11 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_12 = *carry.pop_front().unwrap();
    let mut numerator_12 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_13 = *carry.pop_front().unwrap();
    let mut numerator_13 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_14 = *carry.pop_front().unwrap();
    let mut numerator_14 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_15 = *carry.pop_front().unwrap();
    let mut numerator_15 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_16 = *carry.pop_front().unwrap();
    let mut numerator_16 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_17 = *carry.pop_front().unwrap();
    let mut numerator_17 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_18 = *carry.pop_front().unwrap();
    let mut numerator_18 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_19 = *carry.pop_front().unwrap();
    let mut numerator_19 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_20 = *carry.pop_front().unwrap();
    let mut numerator_20 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_21 = *carry.pop_front().unwrap();
    let mut numerator_21 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_22 = *carry.pop_front().unwrap();
    let mut numerator_22 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_23 = *carry.pop_front().unwrap();
    let mut numerator_23 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_24 = *carry.pop_front().unwrap();
    let mut numerator_24 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_25 = *carry.pop_front().unwrap();
    let mut numerator_25 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_26 = *carry.pop_front().unwrap();
    let mut numerator_26 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_27 = *carry.pop_front().unwrap();
    let mut numerator_27 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_28 = *carry.pop_front().unwrap();
    let mut numerator_28 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_29 = *carry.pop_front().unwrap();
    let mut numerator_29 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_30 = *carry.pop_front().unwrap();
    let mut numerator_30 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_31 = *carry.pop_front().unwrap();
    let mut numerator_31 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_32 = *carry.pop_front().unwrap();
    let mut numerator_32 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_33 = *carry.pop_front().unwrap();
    let mut numerator_33 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_34 = *carry.pop_front().unwrap();
    let mut numerator_34 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_35 = *carry.pop_front().unwrap();
    let mut numerator_35 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_36 = *carry.pop_front().unwrap();
    let mut numerator_36 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_37 = *carry.pop_front().unwrap();
    let mut numerator_37 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_38 = *carry.pop_front().unwrap();
    let mut numerator_38 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_39 = *carry.pop_front().unwrap();
    let mut numerator_39 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_40 = *carry.pop_front().unwrap();
    let mut numerator_40 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_41 = *carry.pop_front().unwrap();
    let mut numerator_41 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_42 = *carry.pop_front().unwrap();
    let mut numerator_42 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_43 = *carry.pop_front().unwrap();
    let mut numerator_43 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_44 = *carry.pop_front().unwrap();
    let mut numerator_44 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_45 = *carry.pop_front().unwrap();
    let mut numerator_45 = *carry.pop_front().unwrap();
    let mut range_check_7_2_5_sum_46 = *carry.pop_front().unwrap();
    let mut numerator_46 = *carry.pop_front().unwrap();
    let mut memory_address_to_id_sum_47 = *carry.pop_front().unwrap();
    let mut numerator_47 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_48 = *carry.pop_front().unwrap();
    let mut numerator_48 = *carry.pop_front().unwrap();
    let mut blake_g_sum_49 = *carry.pop_front().unwrap();
    let mut numerator_49 = *carry.pop_front().unwrap();
    let mut blake_g_sum_50 = *carry.pop_front().unwrap();
    let mut numerator_50 = *carry.pop_front().unwrap();
    let mut blake_g_sum_51 = *carry.pop_front().unwrap();
    let mut numerator_51 = *carry.pop_front().unwrap();
    let mut blake_g_sum_52 = *carry.pop_front().unwrap();
    let mut numerator_52 = *carry.pop_front().unwrap();
    let mut blake_g_sum_53 = *carry.pop_front().unwrap();
    let mut numerator_53 = *carry.pop_front().unwrap();
    let mut blake_g_sum_54 = *carry.pop_front().unwrap();
    let mut numerator_54 = *carry.pop_front().unwrap();
    let mut blake_g_sum_55 = *carry.pop_front().unwrap();
    let mut numerator_55 = *carry.pop_front().unwrap();
    let mut blake_g_sum_56 = *carry.pop_front().unwrap();
    let mut numerator_56 = *carry.pop_front().unwrap();
    let mut blake_round_sum_57 = *carry.pop_front().unwrap();
    let mut numerator_57 = *carry.pop_front().unwrap();
    let mut blake_round_sum_58 = *carry.pop_front().unwrap();
    let mut numerator_58 = *carry.pop_front().unwrap();
...
/// A part 3/3 of the trace-mask eval: re-reads the
/// trace destructure (68/212 columns unboxed) and returns the seam
/// carry for half B (119 QM31s = 476 felts).
pub fn half_a3(
    component: @Component,
    ref sum: QM31,
    ref trace_mask_values: ColumnSpan<Span<QM31>>,
...
pub fn half_b(
    ...
    let blake_round_sigma_sum_0 = *carry.pop_front().unwrap();
    let range_check_7_2_5_sum_1 = *carry.pop_front().unwrap();
    let memory_address_to_id_sum_2 = *carry.pop_front().unwrap();
    let memory_id_to_big_sum_3 = *carry.pop_front().unwrap();
    let range_check_7_2_5_sum_4 = *carry.pop_front().unwrap();
    ...
    let range_check_7_2_5_sum_34 = *carry.pop_front().unwrap();
    let memory_address_to_id_sum_35 = *carry.pop_front().unwrap();
    let memory_id_to_big_sum_36 = *carry.pop_front().unwrap();
    let range_check_7_2_5_sum_37 = *carry.pop_front().unwrap();
    let memory_address_to_id_sum_38 = *carry.pop_front().unwrap();
    let memory_id_to_big_sum_39 = *carry.pop_front().unwrap();
    let range_check_7_2_5_sum_40 = *carry.pop_front().unwrap();
    let memory_address_to_id_sum_41 = *carry.pop_front().unwrap();
    let memory_id_to_big_sum_42 = *carry.pop_front().unwrap();
    let range_check_7_2_5_sum_43 = *carry.pop_front().unwrap();
    let memory_address_to_id_sum_44 = *carry.pop_front().unwrap();
    let memory_id_to_big_sum_45 = *carry.pop_front().unwrap();
    let range_check_7_2_5_sum_46 = *carry.pop_front().unwrap();
    let memory_address_to_id_sum_47 = *carry.pop_front().unwrap();
    let memory_id_to_big_sum_48 = *carry.pop_front().unwrap();
    let blake_g_sum_49 = *carry.pop_front().unwrap();
    let blake_g_sum_50 = *carry.pop_front().unwrap();
    let blake_g_sum_51 = *carry.pop_front().unwrap();
    let blake_g_sum_52 = *carry.pop_front().unwrap();
    let blake_g_sum_53 = *carry.pop_front().unwrap();
    let blake_g_sum_54 = *carry.pop_front().unwrap();
    let blake_g_sum_55 = *carry.pop_front().unwrap();
    let blake_g_sum_56 = *carry.pop_front().unwrap();
    let blake_round_sum_57 = *carry.pop_front().unwrap();
    let blake_round_sum_58 = *carry.pop_front().unwrap();
    assert!(carry.is_empty(), "carry length");
    lookup_constraints(
        ref sum,
        random_coeff,

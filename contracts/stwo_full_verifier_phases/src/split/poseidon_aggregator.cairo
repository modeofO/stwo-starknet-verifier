//! Multi-part fork of the vendored `poseidon_aggregator` component eval along the
...
//! vendor/stwo_cairo_verifier/crates/cairo_air/src/components/poseidon_aggregator.cairo
//! — do not edit by hand; re-run the script after a vendor bump.


use core::num::traits::Zero;
use stwo_cairo_air::components::subroutines::felt_252_unpack_from_27::felt_252_unpack_from_27_evaluate;
use stwo_cairo_air::components::subroutines::poseidon_hades_permutation::poseidon_hades_permutation_evaluate;
use stwo_cairo_air::components::subroutines::read_positive_known_id_num_bits_252::read_positive_known_id_num_bits_252_evaluate;
use stwo_cairo_air::components::poseidon_aggregator::Component;
...
/// trace destructure (87/342 columns unboxed) and returns the mid-A
/// carry: claimed_sum + the 56 accumulators + 27 crossing tmps
/// (84 QM31s = 336 felts).
pub fn half_a1(
    component: @Component,
    ref sum: QM31,
    ...
    out.append(memory_id_to_big_sum_0);
    out.append(numerator_0);
    out.append(memory_id_to_big_sum_1);
    out.append(numerator_1);
    out.append(memory_id_to_big_sum_2);
    out.append(numerator_2);
    out.append(poseidon_full_round_chain_sum_3);
    out.append(numerator_3);
    out.append(poseidon_full_round_chain_sum_4);
    out.append(numerator_4);
    out.append(range_check_252_width_27_sum_5);
    out.append(numerator_5);
    out.append(range_check_252_width_27_sum_6);
    out.append(numerator_6);
    out.append(cube_252_sum_7);
    out.append(numerator_7);
    out.append(range_check_3_3_3_3_3_sum_8);
    out.append(numerator_8);
    out.append(range_check_3_3_3_3_3_sum_9);
    out.append(numerator_9);
    out.append(cube_252_sum_10);
    out.append(numerator_10);
    out.append(range_check_4_4_4_4_sum_11);
    out.append(numerator_11);
    out.append(range_check_4_4_4_4_sum_12);
    out.append(numerator_12);
    out.append(range_check_4_4_sum_13);
    out.append(numerator_13);
    out.append(poseidon_3_partial_rounds_chain_sum_14);
    out.append(numerator_14);
    out.append(poseidon_3_partial_rounds_chain_sum_15);
    out.append(numerator_15);
    out.append(range_check_4_4_4_4_sum_16);
    out.append(numerator_16);
    out.append(range_check_4_4_4_4_sum_17);
    out.append(numerator_17);
    out.append(range_check_4_4_sum_18);
    out.append(numerator_18);
    out.append(range_check_4_4_4_4_sum_19);
    out.append(numerator_19);
    out.append(range_check_4_4_4_4_sum_20);
    out.append(numerator_20);
    out.append(range_check_4_4_sum_21);
    out.append(numerator_21);
    out.append(poseidon_full_round_chain_sum_22);
    out.append(numerator_22);
    out.append(poseidon_full_round_chain_sum_23);
    out.append(numerator_23);
    out.append(memory_id_to_big_sum_24);
    out.append(numerator_24);
    out.append(memory_id_to_big_sum_25);
    out.append(numerator_25);
    out.append(memory_id_to_big_sum_26);
    out.append(numerator_26);
    out.append(poseidon_aggregator_sum_27);
    out.append(numerator_27);
    out.append(packed_input_state_0_tmp_34cc4_2_limb_0);
    out.append(packed_input_state_0_tmp_34cc4_2_limb_1);
    out.append(packed_input_state_0_tmp_34cc4_2_limb_2);
    out.append(packed_input_state_0_tmp_34cc4_2_limb_3);
    out.append(packed_input_state_0_tmp_34cc4_2_limb_4);
    out.append(packed_input_state_0_tmp_34cc4_2_limb_5);
    out.append(packed_input_state_0_tmp_34cc4_2_limb_6);
    out.append(packed_input_state_0_tmp_34cc4_2_limb_7);
    out.append(packed_input_state_0_tmp_34cc4_2_limb_8);
    out.append(packed_input_state_1_tmp_34cc4_5_limb_0);
    out.append(packed_input_state_1_tmp_34cc4_5_limb_1);
    out.append(packed_input_state_1_tmp_34cc4_5_limb_2);
    out.append(packed_input_state_1_tmp_34cc4_5_limb_3);
    out.append(packed_input_state_1_tmp_34cc4_5_limb_4);
    out.append(packed_input_state_1_tmp_34cc4_5_limb_5);
    out.append(packed_input_state_1_tmp_34cc4_5_limb_6);
    out.append(packed_input_state_1_tmp_34cc4_5_limb_7);
    out.append(packed_input_state_1_tmp_34cc4_5_limb_8);
    out.append(packed_input_state_2_tmp_34cc4_8_limb_0);
    out.append(packed_input_state_2_tmp_34cc4_8_limb_1);
    out.append(packed_input_state_2_tmp_34cc4_8_limb_2);
    out.append(packed_input_state_2_tmp_34cc4_8_limb_3);
    out.append(packed_input_state_2_tmp_34cc4_8_limb_4);
    out.append(packed_input_state_2_tmp_34cc4_8_limb_5);
    out.append(packed_input_state_2_tmp_34cc4_8_limb_6);
    out.append(packed_input_state_2_tmp_34cc4_8_limb_7);
    out.append(packed_input_state_2_tmp_34cc4_8_limb_8);
    out
}

/// A part 2/3 of the trace-mask eval: re-reads the
/// trace destructure (200/342 columns unboxed) and returns the mid-A
/// carry: claimed_sum + the 56 accumulators + 0 crossing tmps
/// (57 QM31s = 228 felts).
pub fn half_a2(
    component: @Component,
    ref sum: QM31,
    ...
    let claimed_sum = *component.claimed_sum;
    let mut memory_id_to_big_sum_0 = *carry.pop_front().unwrap();
    let mut numerator_0 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_1 = *carry.pop_front().unwrap();
    let mut numerator_1 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_2 = *carry.pop_front().unwrap();
    let mut numerator_2 = *carry.pop_front().unwrap();
    let mut poseidon_full_round_chain_sum_3 = *carry.pop_front().unwrap();
    let mut numerator_3 = *carry.pop_front().unwrap();
    let mut poseidon_full_round_chain_sum_4 = *carry.pop_front().unwrap();
    let mut numerator_4 = *carry.pop_front().unwrap();
    let mut range_check_252_width_27_sum_5 = *carry.pop_front().unwrap();
    let mut numerator_5 = *carry.pop_front().unwrap();
    let mut range_check_252_width_27_sum_6 = *carry.pop_front().unwrap();
    let mut numerator_6 = *carry.pop_front().unwrap();
    let mut cube_252_sum_7 = *carry.pop_front().unwrap();
    let mut numerator_7 = *carry.pop_front().unwrap();
    let mut range_check_3_3_3_3_3_sum_8 = *carry.pop_front().unwrap();
    let mut numerator_8 = *carry.pop_front().unwrap();
    let mut range_check_3_3_3_3_3_sum_9 = *carry.pop_front().unwrap();
    let mut numerator_9 = *carry.pop_front().unwrap();
    let mut cube_252_sum_10 = *carry.pop_front().unwrap();
    let mut numerator_10 = *carry.pop_front().unwrap();
    let mut range_check_4_4_4_4_sum_11 = *carry.pop_front().unwrap();
    let mut numerator_11 = *carry.pop_front().unwrap();
    let mut range_check_4_4_4_4_sum_12 = *carry.pop_front().unwrap();
    let mut numerator_12 = *carry.pop_front().unwrap();
    let mut range_check_4_4_sum_13 = *carry.pop_front().unwrap();
    let mut numerator_13 = *carry.pop_front().unwrap();
    let mut poseidon_3_partial_rounds_chain_sum_14 = *carry.pop_front().unwrap();
    let mut numerator_14 = *carry.pop_front().unwrap();
    let mut poseidon_3_partial_rounds_chain_sum_15 = *carry.pop_front().unwrap();
    let mut numerator_15 = *carry.pop_front().unwrap();
    let mut range_check_4_4_4_4_sum_16 = *carry.pop_front().unwrap();
    let mut numerator_16 = *carry.pop_front().unwrap();
    let mut range_check_4_4_4_4_sum_17 = *carry.pop_front().unwrap();
    let mut numerator_17 = *carry.pop_front().unwrap();
    let mut range_check_4_4_sum_18 = *carry.pop_front().unwrap();
    let mut numerator_18 = *carry.pop_front().unwrap();
    let mut range_check_4_4_4_4_sum_19 = *carry.pop_front().unwrap();
    let mut numerator_19 = *carry.pop_front().unwrap();
    let mut range_check_4_4_4_4_sum_20 = *carry.pop_front().unwrap();
    let mut numerator_20 = *carry.pop_front().unwrap();
    let mut range_check_4_4_sum_21 = *carry.pop_front().unwrap();
    let mut numerator_21 = *carry.pop_front().unwrap();
    let mut poseidon_full_round_chain_sum_22 = *carry.pop_front().unwrap();
    let mut numerator_22 = *carry.pop_front().unwrap();
    let mut poseidon_full_round_chain_sum_23 = *carry.pop_front().unwrap();
    ...
    let mut memory_id_to_big_sum_25 = *carry.pop_front().unwrap();
    let mut numerator_25 = *carry.pop_front().unwrap();
    let mut memory_id_to_big_sum_26 = *carry.pop_front().unwrap();
    let mut numerator_26 = *carry.pop_front().unwrap();
    let mut poseidon_aggregator_sum_27 = *carry.pop_front().unwrap();
    let mut numerator_27 = *carry.pop_front().unwrap();
    let packed_input_state_0_tmp_34cc4_2_limb_0 = *carry.pop_front().unwrap();
    let packed_input_state_0_tmp_34cc4_2_limb_1 = *carry.pop_front().unwrap();
    let packed_input_state_0_tmp_34cc4_2_limb_2 = *carry.pop_front().unwrap();
    let packed_input_state_0_tmp_34cc4_2_limb_3 = *carry.pop_front().unwrap();
    let packed_input_state_0_tmp_34cc4_2_limb_4 = *carry.pop_front().unwrap();
    let packed_input_state_0_tmp_34cc4_2_limb_5 = *carry.pop_front().unwrap();
    let packed_input_state_0_tmp_34cc4_2_limb_6 = *carry.pop_front().unwrap();
    let packed_input_state_0_tmp_34cc4_2_limb_7 = *carry.pop_front().unwrap();
    let packed_input_state_0_tmp_34cc4_2_limb_8 = *carry.pop_front().unwrap();
    let packed_input_state_1_tmp_34cc4_5_limb_0 = *carry.pop_front().unwrap();
    let packed_input_state_1_tmp_34cc4_5_limb_1 = *carry.pop_front().unwrap();
    let packed_input_state_1_tmp_34cc4_5_limb_2 = *carry.pop_front().unwrap();
    let packed_input_state_1_tmp_34cc4_5_limb_3 = *carry.pop_front().unwrap();
    let packed_input_state_1_tmp_34cc4_5_limb_4 = *carry.pop_front().unwrap();
    let packed_input_state_1_tmp_34cc4_5_limb_5 = *carry.pop_front().unwrap();
    let packed_input_state_1_tmp_34cc4_5_limb_6 = *carry.pop_front().unwrap();
    let packed_input_state_1_tmp_34cc4_5_limb_7 = *carry.pop_front().unwrap();
    let packed_input_state_1_tmp_34cc4_5_limb_8 = *carry.pop_front().unwrap();
    let packed_input_state_2_tmp_34cc4_8_limb_0 = *carry.pop_front().unwrap();
    let packed_input_state_2_tmp_34cc4_8_limb_1 = *carry.pop_front().unwrap();
    let packed_input_state_2_tmp_34cc4_8_limb_2 = *carry.pop_front().unwrap();
    let packed_input_state_2_tmp_34cc4_8_limb_3 = *carry.pop_front().unwrap();
    let packed_input_state_2_tmp_34cc4_8_limb_4 = *carry.pop_front().unwrap();
    let packed_input_state_2_tmp_34cc4_8_limb_5 = *carry.pop_front().unwrap();
    let packed_input_state_2_tmp_34cc4_8_limb_6 = *carry.pop_front().unwrap();
    let packed_input_state_2_tmp_34cc4_8_limb_7 = *carry.pop_front().unwrap();
    let packed_input_state_2_tmp_34cc4_8_limb_8 = *carry.pop_front().unwrap();
...
/// trace destructure (91/342 columns unboxed) and returns the seam
/// carry for half B (57 QM31s = 228 felts).
pub fn half_a3(
    component: @Component,
    ref sum: QM31,
    ref trace_mask_values: ColumnSpan<Span<QM31>>,
    ...
    memory_id_to_big_sum_24 = component
    ...
    memory_id_to_big_sum_25 = component
        .common_lookup_elements
        .combine_qm31(
            [
    ...
    memory_id_to_big_sum_26 = component
        .common_lookup_elements
        .combine_qm31(
            [
    ...
    poseidon_aggregator_sum_27 = component
        .common_lookup_elements
        .combine_qm31(
            [
...
pub fn half_b(
    ...
    let memory_id_to_big_sum_0 = *carry.pop_front().unwrap();
    let memory_id_to_big_sum_1 = *carry.pop_front().unwrap();
    let memory_id_to_big_sum_2 = *carry.pop_front().unwrap();
    let poseidon_full_round_chain_sum_3 = *carry.pop_front().unwrap();
    let poseidon_full_round_chain_sum_4 = *carry.pop_front().unwrap();
    let range_check_252_width_27_sum_5 = *carry.pop_front().unwrap();
    let range_check_252_width_27_sum_6 = *carry.pop_front().unwrap();
    let cube_252_sum_7 = *carry.pop_front().unwrap();
    let range_check_3_3_3_3_3_sum_8 = *carry.pop_front().unwrap();
    let range_check_3_3_3_3_3_sum_9 = *carry.pop_front().unwrap();
    let cube_252_sum_10 = *carry.pop_front().unwrap();
    let range_check_4_4_4_4_sum_11 = *carry.pop_front().unwrap();
    let range_check_4_4_4_4_sum_12 = *carry.pop_front().unwrap();
    let range_check_4_4_sum_13 = *carry.pop_front().unwrap();
    let poseidon_3_partial_rounds_chain_sum_14 = *carry.pop_front().unwrap();
    let poseidon_3_partial_rounds_chain_sum_15 = *carry.pop_front().unwrap();
    let range_check_4_4_4_4_sum_16 = *carry.pop_front().unwrap();
    let range_check_4_4_4_4_sum_17 = *carry.pop_front().unwrap();
    let range_check_4_4_sum_18 = *carry.pop_front().unwrap();
    let range_check_4_4_4_4_sum_19 = *carry.pop_front().unwrap();
    let range_check_4_4_4_4_sum_20 = *carry.pop_front().unwrap();
    let range_check_4_4_sum_21 = *carry.pop_front().unwrap();
    let poseidon_full_round_chain_sum_22 = *carry.pop_front().unwrap();
    let poseidon_full_round_chain_sum_23 = *carry.pop_front().unwrap();
    let memory_id_to_big_sum_24 = *carry.pop_front().unwrap();
    let memory_id_to_big_sum_25 = *carry.pop_front().unwrap();
    let memory_id_to_big_sum_26 = *carry.pop_front().unwrap();
    let poseidon_aggregator_sum_27 = *carry.pop_front().unwrap();
    assert!(carry.is_empty(), "carry length");
    lookup_constraints(
        ref sum,
        random_coeff,

//! Two-half fork of the vendored `poseidon_aggregator` component eval along the
...
/// (28 relation numerators). Returns the seam carry
...
pub fn half_a(
    ...
    carry.append(memory_id_to_big_sum_0);
    carry.append(memory_id_to_big_sum_1);
    carry.append(memory_id_to_big_sum_2);
    carry.append(poseidon_full_round_chain_sum_3);
    carry.append(poseidon_full_round_chain_sum_4);
    carry.append(range_check_252_width_27_sum_5);
    carry.append(range_check_252_width_27_sum_6);
    carry.append(cube_252_sum_7);
    carry.append(range_check_3_3_3_3_3_sum_8);
    carry.append(range_check_3_3_3_3_3_sum_9);
    carry.append(cube_252_sum_10);
    carry.append(range_check_4_4_4_4_sum_11);
    carry.append(range_check_4_4_4_4_sum_12);
    carry.append(range_check_4_4_sum_13);
    carry.append(poseidon_3_partial_rounds_chain_sum_14);
    carry.append(poseidon_3_partial_rounds_chain_sum_15);
    carry.append(range_check_4_4_4_4_sum_16);
    carry.append(range_check_4_4_4_4_sum_17);
    carry.append(range_check_4_4_sum_18);
    carry.append(range_check_4_4_4_4_sum_19);
    carry.append(range_check_4_4_4_4_sum_20);
    carry.append(range_check_4_4_sum_21);
    carry.append(poseidon_full_round_chain_sum_22);
    carry.append(poseidon_full_round_chain_sum_23);
    carry.append(memory_id_to_big_sum_24);
    carry.append(memory_id_to_big_sum_25);
    carry.append(memory_id_to_big_sum_26);
    carry.append(poseidon_aggregator_sum_27);
    carry
}
